The "Kiara modules formatting assistant" context files folder contains LLM configuration files to provide the steps to transform a Python code snippet into a Kiara module.
